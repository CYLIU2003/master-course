...
2026-09-21: [5月の診断結果と配車探索の追加改善](docs/notes/STAGE1_ROOT_SEARCH_DIAGNOSIS_20260921.md)。固定3662b81aは物理・全672区間のBESS保護を通過、充電gap0.368%。配車は600秒で初期解改善0円・gap47.87%となり、目標未達です。日別の厳密な経路被覆下界と2つの根探索設定を追加し、別のclean固定版から限定診断します。全12週完了・メール送信とは扱いません。
