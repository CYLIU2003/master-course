...
**新版の月別12週計算は1月が完走・独立監査済み（1/12週）で、2月を計算中です（2026-09-14 17:49 JST）。** 固定 `8acd8beb` の1月確定費用は4,327,543.646205円、購入量6,251.190 kWh、最大15分平均受電200 kW。[新版の結果表・定義・原本hash](docs/notes/SHIBU21_23_MONTHLY_NUMERIC_RESULTS_20260914.md)。168時間・672 slot、物理・会計、全接続、前後clean SHA、全169求解のStage 2数値設定を確認しました。12週・季節別の最終整理は未完了で、研究採用はBLOCKEDです。
