...
2026-09-11 計算再開の修正: 全接続候補を保持する日跨ぎ接続の共有ノード表現を追加しています。車両・SOC・日次帰庫・複数fragmentを保持し、小規模native差分検証で費用一致と物理検証通過を確認しました。実データの週間計算完了はまだ未確認です。[数学的な条件と検証状況](docs/notes/EXACT_DEPOT_CONNECTION_FACTORS_20260911.md)。
