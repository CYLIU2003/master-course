...
**2026-09-14 17:08 JST、修正した固定版 `8acd8beb` から月別12週の再計算を開始しました。現在は1月の完全Prepare中で、新版の完了週はまだ0/12です。** 4月で発生した数値的な停止を修正し、同じ制約・許容誤差・全月共通設定で計算します。全体テスト2,271 passed / 既存資料2 failed、独立レビュー残P0/P1ゼロ。[原因・検証と実行場所](docs/notes/SHIBU21_23_APRIL_NUMERIC_DIAGNOSIS_20260914.md)。初回試行の完了3週を新版の結果とは扱いません。
