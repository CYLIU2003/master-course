...
3月分も168時間・672 slotと最終物理・会計を通過した。確定費用4,430,823.263078円、購入量7,723.443852 kWh、最大15分平均受電508.143168 kW。原本SHA、日別台帳、PV/購入flow、ピーク、契約超過料金を主担当でも再照合し、月別結果表を3/12週へ更新した。4月以降と季節別集計は継続中。
