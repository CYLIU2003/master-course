...
$researchRoot = 'C:/master-course-worktrees/shibu21-23-monthly-phase-search-20260915'
$controlRoot = 'C:/master-course'
$runtimeRoot = Join-Path $controlRoot 'output/monthly_phase_search_20260915'
$pythonPath = Join-Path $controlRoot '.venv/Scripts/python.exe'
$expectedSha = '7c7c2334040d54722d2f1c354634269d35f8d1de'
...
$campaignPath = Join-Path $researchRoot 'output/monthly_phase_search_campaign_20260915'
...
$arguments = @('-X', 'utf8', '-u', 'scripts/benchmarks/run_exact_seasonal_campaign.py',
    ...
    '--output', 'output/monthly_phase_search_campaign_20260915')
