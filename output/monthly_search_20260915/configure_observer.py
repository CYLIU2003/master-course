...
def main() -> None:
    ...
    expected_sha = "10a40c9faa00d0a4725ae0062d6dbaa223f82bfd"
    ...
    launch = {"status": "RUNNING", "frozen_root": str(frozen), "source_git_sha": source,
              "campaign_relative_path": "output/monthly_search_campaign_20260915",
              ...
              "stage2_search_policy": {"MIPFocus": 1, "Method": 1},
              ...
              "validation": {"full_passed": 2323, "preexisting_ppt_failures": 2,
                             "new_failures": 0, "frozen_focused_passed": 107},
    ...
    config.update(deployment="search", output=str(output), campaign=str(frozen / launch["campaign_relative_path"]),
                  audit=str(BASE / "monthly_budget_independent_audit.json"),
                  report_stem=str(ROOT / "docs/notes/SHIBU21_23_MONTHLY_SEARCH_RESULTS_20260915"),
                  figure_stem=str(ROOT / "docs/notes/figures/shibu21_23_monthly_search_20260915"),
