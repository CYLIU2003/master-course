...
class RunOptimizationBody(BaseModel):
    ...
    stage1_gurobi_search_profile: Literal[
        "default", "bound_focus", "root_cut_focus", "incumbent_focus", "bounded_presolve",
        "bounded_presolve_barrier", "bounded_presolve_norel"
    ] = "default"
    ...
    try:
        ...
        if solver_mode in {
            ...
            is_diagnostic_mode = (
                ...
                or bool(stage1_activation_start_strengthening)
