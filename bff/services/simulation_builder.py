...
def apply_builder_configuration(
    ...
    doc["simulation_config"] = {
        ...
        "initial_soc_percent": _first_defined(
            ...
            body.simulation_settings.initial_soc,
        ),
        "soc_min": soc_min,
        "soc_max": soc_max,
        ...
        "no_improvement_limit": overlay.solver_config.no_improvement_limit,
        "destroy_fraction": overlay.solver_config.destroy_fraction,
        ...
        "initial_ice_fuel_percent": body.simulation_settings.initial_ice_fuel_percent,
        "min_ice_fuel_percent": body.simulation_settings.min_ice_fuel_percent,
        "max_ice_fuel_percent": body.simulation_settings.max_ice_fuel_percent,
        ...
        "solcast_proxy_issue_date": body.simulation_settings.solcast_proxy_issue_date,
        "solcast_typical_curve_path": body.simulation_settings.solcast_typical_curve_path,
        "solcast_typical_weather_class": body.simulation_settings.solcast_typical_weather_class,
