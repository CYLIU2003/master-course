#!/usr/bin/env python3
"""
scripts/catalog/extract_engine_bus.py

CLI runner for Phase 1 engine bus extraction.

Usage:
    python scripts/catalog/extract_engine_bus.py
    python scripts/catalog/extract_engine_bus.py --constant-dir path/to/excel --output-dir path/to/out
...
def main() -> None:
    ...
    parser.add_argument(
        ...
        type=Path,
        default=None,
        help="Directory containing the source Excel files (default: <project_root>/docs/constant)",
    )
    parser.add_argument(
        "--output-dir",
        type=Path,
