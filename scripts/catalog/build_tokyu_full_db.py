"""
scripts/catalog/build_tokyu_full_db.py
==============================
...
実行例:
    python scripts/catalog/build_tokyu_full_db.py
    python scripts/catalog/build_tokyu_full_db.py --skip-stop-timetables
    python scripts/catalog/build_tokyu_full_db.py --resume
    python scripts/catalog/build_tokyu_full_db.py --out data/tokyu_full.sqlite
    python scripts/catalog/build_tokyu_full_db.py --api-key YOUR_KEY
