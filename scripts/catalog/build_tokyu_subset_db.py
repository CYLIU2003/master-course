...
Default editable selection lives in `scripts/catalog/tokyu_subset_config.py`.

Example:
    python scripts/catalog/build_tokyu_subset_db.py --skip-stop-timetables
    python scripts/catalog/build_tokyu_subset_db.py --depots meguro,seta
    python scripts/catalog/build_tokyu_subset_db.py --depots meguro,seta --route-codes 黒01,園01
    python scripts/catalog/build_tokyu_subset_db.py --api-key YOUR_KEY --skip-stop-timetables
"""
...
from scripts.catalog._stop_timetable_fallback import (
    SYNTHETIC_STOP_TIMETABLE_NOTE,
    delete_synthetic_stop_timetables,
    synthesize_missing_stop_timetables,
)
from scripts.catalog.tokyu_subset_config import SELECTED_DEPOTS, SELECTED_ROUTE_CODES
...
def main() -> None:
    ...
    parser.add_argument(
        ...
        help="comma-separated depot keys. Default comes from scripts/catalog/tokyu_subset_config.py",
    )
    parser.add_argument(
        "--route-codes",
