"""
scripts/catalog/rebuild_built_from_normalized.py
=========================================
...
Usage:
    python scripts/catalog/rebuild_built_from_normalized.py
    python scripts/catalog/rebuild_built_from_normalized.py --db data/tokyu_gtfs.sqlite
    python scripts/catalog/rebuild_built_from_normalized.py --dry-run
"""
