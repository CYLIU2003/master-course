...
Usage examples:
    ...
    python scripts/catalog/query_engine_bus.py --manufacturer hino --category route_bus --mode representative

    # Conservative any route_bus with capacity >= 70
    python scripts/catalog/query_engine_bus.py --category route_bus --capacity-min 70 --mode conservative

    # Exact match: route_bus, Isuzu, capacity 75-85, GVW 13000-16000
    python scripts/catalog/query_engine_bus.py --manufacturer isuzu --category route_bus \\
        --capacity-min 75 --capacity-max 85 --gvw-min 13000 --gvw-max 16000 --mode exact_match

    # Look up by model_code
    python scripts/catalog/query_engine_bus.py --model-code LV290N3

    # Return top 3 best-efficiency coach buses
    python scripts/catalog/query_engine_bus.py --category coach_bus --mode best_efficiency --top-n 3
"""
