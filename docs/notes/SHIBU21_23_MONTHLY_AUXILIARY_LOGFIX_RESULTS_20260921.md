...
更新: 2026-09-21T13:14:00.519488+00:00。**2/12週が完了**。固定版 `818e78d0` の確定会計を掲載する。
...
|---|---|---:|---:|---:|---:|---:|---:|
| 1月 | 2025-01-06 | 4,358,002.745292 | 205 | 258,002.745292 | 3,822.012 | 757.609 | 0.00% |
| 2月 | 2025-02-03 | 4,206,322.732177 | 206 | 86,322.732177 | 1,583.378 | 200.000 | 0.00% |
...
- 2025-03-03開始週: `HOURLY_SOLVE_FAILED`。152/168時間まで受理。週間会計は未成立。理由: [STAGE2_NO_INCUMBENT] Charging optimization returned infeasible; no operating plan is available. Inspect the saved Stage 2 diagnostics; an IIS exists only when infeasibility was established.
