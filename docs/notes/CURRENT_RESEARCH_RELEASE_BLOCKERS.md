...
途中更新: 1〜3月は各168時間・672 slot、物理違反0件、会計・日別台帳・source hash照合を通過し、4月を計算中。**3/12週の完了**であり、全12週の完了や季節差の結論ではない。[確定した月の結果](SHIBU21_23_MONTHLY_RESULTS_20260914.md)。以下の「未完了」は12週全体の条件を指す。
