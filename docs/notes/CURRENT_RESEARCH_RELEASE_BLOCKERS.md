...
After PR #7 integration, the combined focused suite passes 105 tests and the
combined complete suite passes 1,647 tests; exact package bytes remain stable.
