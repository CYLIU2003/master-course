...
2026-09-12追記: 後続 `a812aeb2` の春で、未指定単価をEvaluatorだけ0円と解釈する別の不具合を検出した。本記録の「最終会計通過」は当時の検査結果であり、超過料金の正確性が新たに確認された証拠ではない。旧春の会計採用は撤回し、修正後の新規実行が必要。[単価修正と独立料金検査](CONTRACT_OVERAGE_PRICE_DEFAULT_20260912.md)。
