...
最新の固定版 `fa0c22bf` は1月の1週間が完走・独立監査済み（1/12週、2026-09-14 20:52 JST）。総費用4,309,467.438809円、購入量5,631.900 kWh、最大受電206.497 kW。168時間・672 slot、物理・会計・日別台帳差0円、全169充電求解の数値設定、同一予測、全接続、前後cleanを照合した。2月以降の計算と最終季節別整理を継続中で、研究採用はBLOCKED。 受電200 kWの契約超過1.624250000553 kWhに812.125000276318円を計上しており、物理上限と有料契約超過を混同しない。監査schemaで欠けていたPV fallback flagと全接続数を原本から補い、169件のfallback・合成PVへの代替なし、接続候補before/after78,647,760・pruned0を照合。監査記録を受けた独立の集計CLIも原本hash・PV収支・台帳・費用を再検証し、SHIBU21_23_MONTHLY_BUDGET_RESULTS_20260914.md/.jsonを生成した。季節平均・図は12週完了まで生成しない。


## 2026-09-14 共通120秒版の2月完走・監査更新

最新の固定版 `fa0c22bf` は1・2月の2週間が完走・独立監査済み（2/12週、2026-09-14 21:13 JST）。2月の総費用4,222,459.003284円、購入量2,114.490 kWh、最大受電200.000 kW。各週168時間・672 slot、物理検証、会計と日別台帳の差0円、各169充電求解の数値設定、同一予測、全接続、前後cleanを照合した。3月以降の計算と最終季節別整理を継続中で、研究採用はBLOCKED。 1・2月の費用表と原本hashを再生成した。監査CLIは全169求解を読み、設定、代替・修復・接続削減なし、運行会社・距離、曜日構成、予測、BESS終端、物理・会計・sourceを確認する。2月の車両日数206、車両使用費以外102,459.003284円、PV発電21,340.7375 kWh、PV抑制3,776.148033 kWh（17.69%）、BESS在庫減少約1,800 kWh。1月との差は総費用−87,008.435526円（車両使用費＋20,000円、その他−107,008.435526円）で、月内代表性・配車・有限時間探索の影響を含む記述値として保持する。2月hour_065（2025-02-05 17:00 JST開始窓）のnative最大制約残差は1.724401954561472e-9であり、FeasibilityTol設定1e-9と実残差を同一視しない。既定のengine/物理検証の受理を別に確認し、全残差が設定値以下とは主張しない。監査の完了判定はcampaign実完了と宣言12週すべての独立監査passの両方を要求する。計算完了・監査不足、監査完了・計算未完了を区別し、宣言外の週を拒否する境界検査が通過した。古いcampaign_progressの4キーを継承しないようにし、2/12の正規キーへ更新。1月も同じCLIで再監査し、collectorを再実行した。実行中の固定ソース・条件・結果は変更していない。


## 2026-09-14 月別固定版fa0c22bf: 2025-03-03の週間監査を反映

最新の固定版 `fa0c22bf` は1〜3月の3週間が完走・独立監査済み（3/12週、2026-09-14 21:38 JST）。3月の総費用4,406,044.133810円、購入量8,036.650 kWh、最大受電208.798 kW。各週168時間・672 slot、物理検証、会計と日別台帳の差1e-6円以内、各169充電求解の数値設定、同一予測、全接続、前後cleanを照合した。4月以降の計算と最終季節別整理を継続中。研究採用はBLOCKED。 車両日数206、車両使用費以外286,044.133810円、PV発電14,855.875000 kWh、PV抑制率26.0851%、BESS在庫減少1,800.000000 kWh。native最大制約残差は8.3332624095211038e-10。数値設定の一致と実残差・独立物理検証を区別する。確定会計・台帳・PV収支・各原本hashを集計CLIでも照合し、同名Markdown/JSONへ反映した。計算中の固定ソース、入力、制約、予測、時間枠は変更していない。


## 2026-09-14 月別予測の学習範囲・実行入力来歴を再照合

2024年学習の除外日は2月5日と3月8日で、referenceの固体降水の代理判定が未確定だったためである。採用364日は全て2024年、2025年履歴の学習混入なしを確認し、月別計画へ日付・理由・未評価の影響を追記した。意味モデルSHA（content_hash）は0b876e8e…7599eb、training_modelファイルSHAはd7b6b151…22b8cdで、異なる対象のハッシュである。

予測の学習モデルと全12週の予測ファイルはmainと固定版でバイト一致。manifestはimplementation_sha256の値に改行コード由来の差があり、main対固定版のmanifest全体の一致不成立をforecast_training_coverage_audit.jsonに保持した。一方、固定版のmanifestを含む47ファイルは、実行前monthly_input_import.jsonのSHAと全件一致し、移設scenario metadataも一致した。coverage監査のexecution_import_contractはPASS。予測値や凍結原本を整形・書換えして一致させる処理は行っていない。
...
## 2026-09-14 月別固定版fa0c22bf: 2025-04-07の週間監査を反映

最新の固定版 `fa0c22bf` は1〜4月の4週間が完走・独立監査済み（4/12週、2026-09-14 22:19 JST）。4月の総費用4,496,415.122948円、購入量3,051.719 kWh、最大受電633.818 kW。各週168時間・672 slot、物理検証、会計と日別台帳の差1e-6円以内、各169充電求解の数値設定、同一予測、全接続、前後cleanを照合した。5月以降の計算と最終季節別整理を継続中。研究採用はBLOCKED。 車両日数206、車両使用費以外376,415.122948円、PV発電26,353.612500 kWh、PV抑制率37.7380%、BESS在庫減少1,800.000000 kWh。native最大制約残差は3.3783180697355419e-09。数値設定の一致と実残差・独立物理検証を区別する。確定会計・台帳・PV収支・各原本hashを集計CLIでも照合し、同名Markdown/JSONへ反映した。計算中の固定ソース、入力、制約、予測、時間枠は変更していない。


## 2026-09-14 月別処理のスクリプト化と完了メール

ユーザーのトークン節約指示に対応し、scripts/watch_monthly_campaign.py と起動PowerShellを追加。60秒ごとのローカル監視、既存CLIによる完走週監査、月別途中表・文書同期、最終図表・季節示唆生成を実行し、完了時だけ既存taskへqueueする。Gmail接続を確認し、全12週の最終レビュー後にユーザー指定先へ1通送る手順・重複検査・実message ID記録を文書化した。メールは未送信。Solcast automationは30分ごとから従来の日次12時へ戻した。

設定全体SHAと固定path境界、OS排他lock、PID開始時刻、失敗保持、早期完了拒否、queue受理不明時の無条件再送禁止を実装。試験で別担当のREADME導入段落追加に弱い既存checkpoint処理を発見し、一意な現在結果段落で更新するよう修正。他者の説明文を保存し、LF/CRLF回帰検査を追加。47 focused testsが1.83秒で通過し、4月の169native・168時間・672slot・物理・会計監査と4/12週への実文書同期が成功した。固定実験fa0c22bfは変更も再起動もしていない。研究採用BLOCKEDは継続。

[完了時の具体的なメール処理](MONTHLY_COMPLETION_DELIVERY_20260914.md)。


## 2026-09-14 月別固定版fa0c22bf: 2025-05-12の週間監査を反映

最新の固定版 `fa0c22bf` は1〜5月の5週間が完走・独立監査済み（5/12週、2026-09-14 22:42 JST）。5月の総費用4,379,833.004971円、購入量4,157.161 kWh、最大受電394.031 kW。各週168時間・672 slot、物理検証、会計と日別台帳の差1e-6円以内、各169充電求解の数値設定、同一予測、全接続、前後cleanを照合した。6月以降の計算と最終季節別整理を継続中。研究採用はBLOCKED。 車両日数206、車両使用費以外259,833.004971円、PV発電26,623.912500 kWh、PV抑制率42.6717%、BESS在庫減少1,800.000000 kWh。native最大制約残差は5.4003024274607014e-10。数値設定の一致と実残差・独立物理検証を区別する。確定会計・台帳・PV収支・各原本hashを集計CLIでも照合し、同名Markdown/JSONへ反映した。計算中の固定ソース、入力、制約、予測、時間枠は変更していない。


## 2026-09-14 月別固定版fa0c22bf: 2025-06-02の週間監査を反映

最新の固定版 `fa0c22bf` は1〜6月の6週間が完走・独立監査済み（6/12週、2026-09-14 23:13 JST）。6月の総費用4,250,717.703300円、購入量2,977.680 kWh、最大受電208.047 kW。各週168時間・672 slot、物理検証、会計と日別台帳の差1e-6円以内、各169充電求解の数値設定、同一予測、全接続、前後cleanを照合した。7月以降の計算と最終季節別整理を継続中。研究採用はBLOCKED。 車両日数206、車両使用費以外130,717.703300円、PV発電31,573.250000 kWh、PV抑制率47.7026%、BESS在庫減少1,800.000000 kWh。native最大制約残差は9.2543951382619439e-10。数値設定の一致と実残差・独立物理検証を区別する。確定会計・台帳・PV収支・各原本hashを集計CLIでも照合し、同名Markdown/JSONへ反映した。計算中の固定ソース、入力、制約、予測、時間枠は変更していない。


## 2026-09-14 月別固定版fa0c22bf: 2025-07-07の週間監査を反映

最新の固定版 `fa0c22bf` は1〜7月の7週間が完走・独立監査済み（7/12週、2026-09-14 23:43 JST）。7月の総費用4,205,695.865185円、購入量1,461.216 kWh、最大受電210.522 kW。各週168時間・672 slot、物理検証、会計と日別台帳の差1e-6円以内、各169充電求解の数値設定、同一予測、全接続、前後cleanを照合した。8月以降の計算と最終季節別整理を継続中。研究採用はBLOCKED。 車両日数206、車両使用費以外85,695.865185円、PV発電32,026.300000 kWh、PV抑制率43.4476%、BESS在庫減少1,793.220132 kWh。native最大制約残差は6.2028959746385226e-10。数値設定の一致と実残差・独立物理検証を区別する。確定会計・台帳・PV収支・各原本hashを集計CLIでも照合し、同名Markdown/JSONへ反映した。計算中の固定ソース、入力、制約、予測、時間枠は変更していない。


## 2026-09-14 月別固定版fa0c22bf: 2025-08-04の週間監査を反映

最新の固定版 `fa0c22bf` は1〜8月の8週間が完走・独立監査済み（8/12週、2026-09-15 00:14 JST）。8月の総費用4,430,281.405265円、購入量3,163.050 kWh、最大受電479.568 kW。各週168時間・672 slot、物理検証、会計と日別台帳の差1e-6円以内、各169充電求解の数値設定、同一予測、全接続、前後cleanを照合した。9月以降の計算と最終季節別整理を継続中。研究採用はBLOCKED。 車両日数206、車両使用費以外310,281.405265円、PV発電30,537.737500 kWh、PV抑制率46.3371%、BESS在庫減少1,800.000000 kWh。native最大制約残差は6.936033969395794e-10。数値設定の一致と実残差・独立物理検証を区別する。確定会計・台帳・PV収支・各原本hashを集計CLIでも照合し、同名Markdown/JSONへ反映した。計算中の固定ソース、入力、制約、予測、時間枠は変更していない。


## 2026-09-14 月別固定版fa0c22bf: 2025-09-01の週間監査を反映

最新の固定版 `fa0c22bf` は1〜9月の9週間が完走・独立監査済み（9/12週、2026-09-15 00:44 JST）。9月の総費用4,295,456.254498円、購入量3,280.300 kWh、最大受電251.148 kW。各週168時間・672 slot、物理検証、会計と日別台帳の差1e-6円以内、各169充電求解の数値設定、同一予測、全接続、前後cleanを照合した。10月以降の計算と最終季節別整理を継続中。研究採用はBLOCKED。 車両日数206、車両使用費以外175,456.254498円、PV発電27,778.425000 kWh、PV抑制率41.6307%、BESS在庫減少1,799.262118 kWh。native最大制約残差は7.3987393989227712e-10。数値設定の一致と実残差・独立物理検証を区別する。確定会計・台帳・PV収支・各原本hashを集計CLIでも照合し、同名Markdown/JSONへ反映した。計算中の固定ソース、入力、制約、予測、時間枠は変更していない。


## 2026-09-14 月別固定版fa0c22bf: 2025-10-06の週間監査を反映

最新の固定版 `fa0c22bf` は1〜10月の10週間が完走・独立監査済み（10/12週、2026-09-15 01:16 JST）。10月の総費用4,269,784.456240円、購入量4,354.188 kWh、最大受電200.795 kW。各週168時間・672 slot、物理検証、会計と日別台帳の差1e-6円以内、各169充電求解の数値設定、同一予測、全接続、前後cleanを照合した。11月以降の計算と最終季節別整理を継続中。研究採用はBLOCKED。 車両日数205、車両使用費以外169,784.456240円、PV発電17,269.025000 kWh、PV抑制率13.1710%、BESS在庫減少1,800.000000 kWh。native最大制約残差は8.4673956735059619e-10。数値設定の一致と実残差・独立物理検証を区別する。確定会計・台帳・PV収支・各原本hashを集計CLIでも照合し、同名Markdown/JSONへ反映した。計算中の固定ソース、入力、制約、予測、時間枠は変更していない。


## 2026-09-15 月別固定版fa0c22bf: 11月day-ahead停止を記録

1〜10月が監査済みで、11月はStage 2の120秒上限でno-incumbent、受理0時間、12月未実行。campaignのcompleted_weeksに失敗した11月も含まれるため、checkpoint helperで成功監査の集合と終了ケース数を区別し、10/12成功・STOPPEDを表示するよう修正した。監査JSONに失敗summary SHAと理由を追加し、費用0円は週間結果へ入れず、停止版の途中報告とREADME/blocker/計画/launchを同期した。追加回帰を含む48 testsが1.84秒で通過。
