...
更新: 2026-09-21T17:40:16.469403+00:00。**3/12週が完了**。固定版 `3289f07b` の確定会計を掲載する。
...
|---|---|---:|---:|---:|---:|---:|---:|
| 1月 | 2025-01-06 | 4,366,035.788874 | 205 | 266,035.788874 | 3,836.329 | 473.624 | 0.00% |
| 2月 | 2025-02-03 | 4,206,177.724767 | 206 | 86,177.724767 | 1,578.623 | 200.000 | 8.88% |
| 3月 | 2025-03-03 | 4,823,983.769033 | 206 | 703,983.769033 | 6,772.152 | 476.718 | 5.58% |
...
- 2025-04-07開始週: `DAY_AHEAD_FAILED`。0/168時間まで受理。週間会計は未成立。理由: [STAGE2_NO_INCUMBENT] Charging optimization returned infeasible; no operating plan is available. Inspect the saved Stage 2 diagnostics; an IIS exists only when infeasibility was established.
