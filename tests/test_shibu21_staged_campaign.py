...
def test_day_and_month_requests_explicitly_reject_impossible_depot_resets():
    day = day_request("prepared-day")
    month = monthly_request("prepared-week")
    assert day["stage1_fragment_transition_cut_mode"] == "explicit_root"
    assert month["stage1_fragment_transition_cut_mode"] == "explicit_root"
