...
def _problem() -> SimpleNamespace:
    ...
    scenario = SimpleNamespace(timestep_min=5, diesel_price_yen_per_l=0.0, co2_price_per_kg=0.0)
...
def test_build_accounting_artifacts_minimum_case() -> None:
    ...
    artifacts = build_accounting_artifacts(
        ...
        trip_assignment_rows=[
            {
                ...
                "actual_arrival": "2025-08-05T08:05:00",
                "distance_km": 10.0,
        ...
        vehicle_soc_timeseries_rows=[
            ...
            {"date": "2025-08-05", "time": "08:05", "vehicle_id": "veh-1", "soc_kwh": 60.0, "state": "charging"},
        ],
    ...
    assert artifacts.summary["peak_grid_kw"] == 240.0
