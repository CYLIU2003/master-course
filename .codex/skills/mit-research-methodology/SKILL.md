...
description: "学術研究の計画、実験設計、仮説検証、研究結果の解釈、論文執筆に使う。一般的な調査、ログ分析、指示ファイルの監査だけには適用しない。"
---

# MIT-Style Research Methodology Skill

依頼された研究工程に関係する節だけを適用する。統計解析・倫理手続き・論文構成の例は、それぞれ対象となる研究に限る。文献調査や実験の実行を、別工程の依頼から自動的に追加しない。
