...
def main() -> None:
    ...
    from scripts.benchmarks.shibu24_optimization_store import load_database
    from tools.research.shibu24_monthly import _overnight_contract
    ...
    _, source_tables = load_database(args.database_dir.resolve())
    overnight = _overnight_contract(doc, source_tables["timetable_rows"])
    doc["simulation_config"].update(
        execution_profile="existing_solver_v1",
        solver_mode="mode_milp_only",
        time_limit_seconds=120,
        stage1_time_limit_seconds=600,
    ...
    request = {
        ...
        "stage2_time_limit_seconds": 120, "gurobi_threads": 2,
    ...
    audit = {"status": "PREPARED_DIAGNOSTIC_ONLY", "source": source_audit,
             ...
             "limitations": ["2026 scheduled timetable paired with 2025 historical weather",
                             ...
                             "Phase 3 two-stage result is not an integrated global cost optimum"]}
